...
class WebsocketSessionByIdExpiryStreamProcessor (applicationId : String,
        ...
        with(polarisKafka) {
            ...
            consumeStream(websocketEventsTopic)
                ...
                .mapValues { key, value ->
                    ...
                    //
                    println("Websockets-By-Id Key: $key SESSION EXPIRATION (from ${websocketSessionsTopic.topic})")
                    null
                }
